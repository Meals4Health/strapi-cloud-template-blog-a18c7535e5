...
export interface ApiAboutUsEntryAboutUsEntry extends Schema.CollectionType {
  collectionName: 'about_us_entries';
  info: {
    singularName: 'about-us-entry';
    pluralName: 'about-us-entries';
    displayName: 'AboutUsEntries';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::about-us-entry.about-us-entry',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSocialMediaEntrySocialMediaEntry
  extends Schema.CollectionType {
  collectionName: 'social_media_entries';
  info: {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::social-media-entry.social-media-entry',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::social-media-entry.social-media-entry': ApiSocialMediaEntrySocialMediaEntry;
    }
  }
}
